...
export default function DeveloperMessagesStatic() {
  return (
      ...
      <Card className="h-full flex flex-col">
        ...
        <CardContent className="p-4 border-b">
          <h2 className="text-lg font-semibold text-zinc-900">
            Acme Corp – Frontend Dashboard Project
          </h2>
        ...
        <CardContent className="flex-1 overflow-y-auto space-y-4 p-6">
          <div className="flex justify-start">
            <div className="max-w-[70%] bg-zinc-100 rounded-lg px-4 py-2 text-sm text-zinc-900">
              ...
              <div className="text-[11px] text-zinc-500 mt-1">10:15 AM</div>
            </div>
          </div>

          <div className="flex justify-end">
            <div className="max-w-[70%] bg-indigo-600 text-white rounded-lg px-4 py-2 text-sm">
              Good morning. Thank you for reviewing my application.
              I would be happy to clarify any details if required.
              <div className="text-[11px] opacity-80 mt-1 text-right">10:17 AM</div>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="max-w-[70%] bg-zinc-100 rounded-lg px-4 py-2 text-sm text-zinc-900">
              ...
              <div className="text-[11px] text-zinc-500 mt-1">10:20 AM</div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="max-w-[70%] bg-indigo-600 text-white rounded-lg px-4 py-2 text-sm">
              ...
              <div className="text-[11px] opacity-80 mt-1 text-right">10:22 AM</div>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="max-w-[70%] bg-zinc-100 rounded-lg px-4 py-2 text-sm text-zinc-900">
              ...
              <div className="text-[11px] text-zinc-500 mt-1">10:25 AM</div>
            </div>
          </div>
        </CardContent>
